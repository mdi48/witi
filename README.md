...
This is just a simple tool I made as a project to help me learn Go, and is intended for my own personal use (at least for now), and only supports the pacman package manager as a result (again, this might change in future.)
